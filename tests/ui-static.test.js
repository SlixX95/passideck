...
assert.ok(
  ...
  'the working spinner must prefer native Hermes lifecycle events while retaining rendered ui.busy as the disconnect/restart fallback'
);
...
assert.ok(html.includes('app.js?v=20260801-session-bell-v1') && html.includes('style.css?v=20260801-session-bell-v1'), 'client cache keys must activate the session response bell with native Hermes lifecycle events and legacy fallbacks');
