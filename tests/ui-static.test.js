...
assert.ok(html.includes('app.js?v=20260801-hermes-wheel-v3') && html.includes('style.css?v=20260801-hermes-wheel-v3'), 'client cache keys must activate normal Hermes wheel ownership across stale alternate-buffer state');
