...
assert.ok(html.includes('app.js?v=20260719-hermes-wheel-zero-scrollback') && html.includes('style.css?v=20260719-hermes-wheel-zero-scrollback'), 'client cache keys must activate normal Hermes zero-scrollback wheel ownership');
