...
assert.ok(html.includes('app.js?v=20260801-session-bell-v2') && html.includes('style.css?v=20260801-session-bell-v2'), 'client cache keys must activate the session response bell with native Hermes lifecycle events and legacy fallbacks');
