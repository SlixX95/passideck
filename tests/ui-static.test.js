...
assert.ok(html.includes('app.js?v=20260808-hermes-session-preservation-v5') && html.includes('style.css?v=20260808-hermes-session-preservation-v5'), 'client cache keys must activate the corrected terminal runtime and surface styling together');
