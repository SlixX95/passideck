...
assert.ok(html.includes('app.js?v=20260801-retitle-v1') && html.includes('style.css?v=20260801-desktop-reload-v1'), 'client cache keys must activate restored desktop repaint and redraw');
