...
assert.ok(html.includes('app.js?v=20260718-tui-title-scrollbar') && html.includes('style.css?v=20260718-tui-title-scrollbar'), 'client cache keys must activate TUI titles and hidden TUI scrollbars');
