...
assert.ok(html.includes('app.js?v=20260718-desktop-layout-isolation') && html.includes('style.css?v=20260718-desktop-layout-isolation'), 'client cache keys must activate conflict-safe desktop persistence and native TUI wheel routing');
